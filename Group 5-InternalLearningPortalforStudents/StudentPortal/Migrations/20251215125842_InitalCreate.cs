        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Taker = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesSections", x => x.CourseSectionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoursesSections_Lecturers_LecturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesMaterials", x => x.CourseMaterialId);
                    table.ForeignKey(
                        name: "FK_CoursesMaterials_CoursesSections_CourseSectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_CoursesSections_CourseSectionId",
                        column: x => x.CourseSectionId,
                        principalTable: "CoursesSections",
                        principalColumn: "CourseSectionId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleItems_CoursesSections_CourseSectionId",
                        column: x => x.CourseSectionId,
                        principalTable: "CoursesSections",
                        principalColumn: "CourseSectionId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scores_CoursesSections_CourseSectionId",
                        column: x => x.CourseSectionId,
                        principalTable: "CoursesSections",
                        principalColumn: "CourseSectionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Scores_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "LecturerId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesMaterials_CourseSectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesSections_LecturerId",
                table: "CoursesSections",
                column: "LecturerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItems_CourseSectionId",
                table: "ScheduleItems",
                column: "CourseSectionId");
